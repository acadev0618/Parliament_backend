                            ...
                            <table class="table table-striped table-bordered table-hover" id="home_table">
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd gradeX getRedirectKey" data-key="{{ $home_list->key }}">
                                        ...
                                        <td>
                                            <a class="editHomeListModal" data-id="{{ $home_list->id }}" data-title="{{ $home_list->title }}" data-subtitle="{{ $home_list->subtitle }}" data-key="{{ $home_list->key }}" data-toggle="modal"><i class="fa fa-edit" data-toggle="tooltip" title="Edit"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                    @endif
