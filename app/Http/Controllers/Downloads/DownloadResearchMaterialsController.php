...
class DownloadResearchMaterialsController extends Controller {

    public function index() {
        if(Session::get('display_name')) {

            $data = DB::select('select * from downloads where kind = 4', [1]);

            return view('downloads.researchMaterials')->with(
            	['data' => $data, 
    ...
    public function createResearchMaterials(Request $request) {
    ...
    public function updateResearchMaterials(Request $request) {
    ...
    public function deleteResearchMaterials(Request $request) {
        $id = array(
            'id' => $request->id
        );
    ...
    public function multiDeleteResearchMaterials(Request $request) {
        $ids = $request->ids;
        $ids = explode(',', $ids);
        $result = 0;
